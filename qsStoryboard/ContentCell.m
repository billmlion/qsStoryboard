...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [txtContent setLineBreakMode:UILineBreakModeWordWrap];
...
{//280  
    ...
    CGSize size = [txtContent.text sizeWithFont:font constrainedToSize:CGSizeMake(contentWidth, 3000) lineBreakMode:UILineBreakModeWordWrap];  
